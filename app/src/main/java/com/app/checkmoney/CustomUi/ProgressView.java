...
public class ProgressView extends View {
    ...
    public ProgressView(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.ProgressView));
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius =
                (int) a.getDimension(R.styleable.ProgressView_matProg_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.ProgressView_matProg_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.ProgressView_matProg_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.ProgressView_matProg_rimWidth, rimWidth);

        float baseSpinSpeed =
                a.getFloat(R.styleable.ProgressView_matProg_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime =
                a.getInt(R.styleable.ProgressView_matProg_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.ProgressView_matProg_barColor, barColor);

        rimColor = a.getColor(R.styleable.ProgressView_matProg_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.ProgressView_matProg_linearProgress, false);

        if (a.getBoolean(R.styleable.ProgressView_matProg_progressIndeterminate, true)) {
            spin();
        }
